...
import aviator from "../../../assets/assets/aviator/aviator.gif";
import fan_aviator from "../../../assets/assets/aviator/fan_aviator.gif";
...
function AviatorFlight({ changeBg, setChangeBg, isSoundOn, setIsSoundOn, isPathRemoved, setIsPathRemoved }) {
    ...
    return (
      <div
        ref={parentRef}
        className="h-[98%] relative border-[0.2px] overflow-hidden border-gray rounded-2xl bg-blackAviator2"
      >
        {isModalOpen && (
          <div className="absolute top-[30%] -left-5 xsm:left-[30%] xl:left-[40%] z-40 p-6 w-96 flex flex-col items-center justify-center">
            {hotAirData?.status == 2 ? (
              <div
