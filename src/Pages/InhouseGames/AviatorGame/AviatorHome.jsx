  ...
  return (
    <>
      ...
      <div className=" w-full xl:flex text-black justify-center h-[calc(100%-3.22rem)] px-2 pt-2 gap-2">
        <div className="order-2  xl:mt-0 h-[70vh] sm:h-[100%] w-full xlg:w-[70vw] rounded-md gap-2">
          <div className="h-[50%] lg:h-[67%]">
            ...
            <div className="w-[100%] text-sm flex items-center justify-between text-gray">
          ...
          <div className="pt-10 mt-5 h-[25%] md:h-[calc(100%-67%-50px)]">
            <BetSection
              setBtn={setBtn}
        ...
        <div
          className={` ${
            btn.btn1 && btn.btn2
              ...
              ? "mt-[175px]"
              : "mt-[135px]"
          } sm:mt-[90px] lg:mt-2 xl:mt-0 order-1 xlg:w-[40vw] h-full p-2 rounded-md bg-blackAviator2`}
        >
