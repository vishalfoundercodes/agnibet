...
function BetButtonTwo({ setBtn, setBetApiHitted }) {
  ...
  return (
    <div className="w-full py-1  lg:py-0  text-sm xsm:text-sm px-2 lg2:px-6  bg-blackAviator2 rounded-md flex flex-col items-center">
      ...
      {/* Bet Amount Control */}
      <div className="grid grid-cols-5 gap-2 w-full bg- mb-1">
        <div className="col-span-2 flex flex-col items-center">
          ...
          {isAuto && (
            <div
              ...
              className="w-full -mt-1 text-sm xsm:text-sm text-gray flex items-center justify-center"
            >
              Auto Bet &nbsp;
              <button>
                {isAutoBetAndCashout.autoBet ? (
        ...
        {betStatus ? (
          ...
          <div className="mt-2 col-span-3 w-full">
            ...
            {isAuto && (
              <div className="text-ssm xsm:sm flex items-center justify-center gap-1 xsm:gap-2">
