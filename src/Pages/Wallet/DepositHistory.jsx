...
export default function DepositHistory() {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(`${apis.deposit_history}${userId}`);
  ...
  return (
    <div
      className="w-full  mx-auto min-h-screen px-4 py-2 lg2:py-0"
      style={{
        fontFamily: "Inter",
      }}
    >
            ...
            <div className="mb-3">
              ...
              <div className="flex justify-between gap-2 mb-2">
                <button
                  ...
                  className="w-full bg-lightGray lg2:bg-lgGray lg2:text-red text-white py-2 rounded-[8px] font-medium text-ssm"
                >
                  {t(`Just_For_Today`)}
                </button>
                <button
          ...
          : "bg-white text-lightGray border-grayBorder"
            ...
            <div className="space-y-3">
              {filteredData.map((deposit, index) => (
                <div
                  key={index}
                  className="bg-red lg2:bg-red text-white rounded-xl shadow p-4 flex justify-between items-center"
                >
                  <div>
