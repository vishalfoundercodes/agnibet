          ...
          {/* <button
              className={`px-4 rounded-xl border flex flex-col items-center justify-center space-y-1 lg2:py-6  cursor-pointer ${
                selectedPayment === "manual"
                  ? "border-red bg-lightMain text-white"
            ...
            >
              ...
              <span className="text-ssm font-medium">{t(`Bank_Payment`)}</span>
            </button> */}
          {/* crypto */}
          {/* <button
            ...
            >
              ...
              <span className="text-ssm font-medium">{t(`Crypto`)}</span>
            </button> */}
          {/* <button
              className={`px-4 rounded-xl border flex flex-col items-center justify-center space-y-1 cursor-pointer ${
            ...
            >
              ...
              <span className="text-ssm font-medium">
                {t(`Phone_Payment`)}
              </span>
            </button> */}
          {/* </div> */}
          ...
          {selectedPayment !== 7 && (
            <div className="flex items-center gap-2 border rounded-[8px] border-grayBorder px-3 py-1">
              ...
              <input
                ...
                className="w-full outline-none text-white font-normal"
              />
              <span className="text-black font-medium">BDT</span>
            </div>
          )}
