...
//         {/* ✅ Payment Details — from pay_modes API */}
//         {payModeData && (
//           <div className="bg-red rounded-[8px] shadow p-4">
//             <h2 className="text-white font-semibold mb-4">
//               {t("Payment_Details")}
...
//                 <div className="flex flex-col items-center rounded-2xl p-4 border border-gray-700 bg-[#151d2d]">
//                   <h3 className="text-white text-[14px] font-semibold mb-2">
//                     QR Code
//                   </h3>
//                   <img
...
//                     </button>
//                   </div>
//                   <p className="text-white font-semibold text-lg mt-4 bg-[#131a2b] border border-gray-700 rounded-lg p-4 break-all">
//                     {payModeData.upi_id}
//                   </p>
//                 </div>
//               )}

//               {/* Account Number — show if API returns it in future */}
...
//       // ✅ FormData — screenshot as base64 string (as shown in API example)
//       const formData = new FormData();
//       formData.append("user_id", localStorage.getItem("userId"));
//       formData.append("amount", String(numAmount));
//       formData.append("utr_number", utrNumber);
//       formData.append("screenshot", file); // base64 string from FileReader

//       console.log("deposit_request payload:", {
//         user_id: localStorage.getItem("userId"),
//         amount: String(numAmount),
//         utr_number: utrNumber,
//         screenshot: file?.substring(0, 50) + "...",
//       });
