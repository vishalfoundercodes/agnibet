...
const GameHistoryBox = ({ isVisible, gameHistoryData }) => {
  ...
  return (
    <div className="w-full px-4 mt-5">
      {/* Header */}
      <div className="flex text-sm w-full bg-[#3A3947] rounded-t-lg py-2 font-semibold">
        <p className="  w-[25%] flex justify-center items-center">Period</p>
        <p className="  w-[22%] flex justify-center items-center">Number</p>
        <p className="  w-[30%] flex justify-center items-center">Big Small</p>
